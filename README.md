# 简易 IM 系统 (Instant Messaging)

一个教学用的即时通讯系统，演示 TCP 网络编程、协议设计、多连接管理、用户认证等核心技术。
...
- [**群组聊天功能**](GROUP_CHAT_FEATURES.md) - 群组管理和实时消息广播 ⭐ **新增**
